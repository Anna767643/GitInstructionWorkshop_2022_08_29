...
Контроль версий нужен для сохранинея измениней и различных версий документа без копирования всего файла, а с сохранением только изменненых моментов. Так же контроль версий нужен для одновременной работы людей с одним и тем же файлом.
